            ...
            <div className="flex-1 overflow-y-auto p-8 md:p-10 space-y-10 scrollbar-thin scrollbar-thumb-ui-border">
              ...
              <section className="space-y-4">
                ...
                <div className="p-8 bg-text-primary text-bg-primary rounded-3xl shadow-xl border border-ui-border/10 italic font-serif text-xl leading-relaxed">
                  <span className="text-accent font-bold">XeJesUs</span> is the divine synthesis of <span className="underline decoration-accent/40 underline-offset-4">Exegesis</span> ("leading out" the original intended meaning of a passage—specifically focusing on the role and person of Jesus—rather than inserting one's own biases (eisegesis)) and the name of <span className="text-accent">Our Savior, Jesus Christ</span>.
